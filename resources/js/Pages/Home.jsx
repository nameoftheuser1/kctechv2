            ...
            <section className="flex flex-col md:flex-row container mx-auto px-5 my-14">
                <div className="w-full my-auto">
                    ...
                    <p className="text-gray-700 cursor-default">
                        ...
                        Kandahar Resort, where we offer a variety of rooms and
                        services tailored to make your stay unforgettable.
                        Reservations are easy and convenient.
                    </p>
                    <div className="flex flex-col md:flex-row gap-0 mt-8 sm:gap-10 items-start sm:items-center">
                        ...
                        >
                            <h1 className="text-blue-900 text-[50px]">0</h1>
                            <p className="text-sm text-gray-700">Book now</p>
                        </div>
                    </div>
                </div>
